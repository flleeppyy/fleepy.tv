    ...
    if (attributes.length !== 0) {
      ...
      for (var i = 0, l = prevs.length; i !== l; ++i) {
        ...
        for (var key in attrs) {
          ...
          if (
            lastChar === "*" &&
            tempAttr.indexOf(attrs[key + lastChar]) === -1
          ) {
            shouldAdd = false;
            break;
          }
          // Case: [href^=/en]
            ...
            lastChar === "^" &&
            tempAttr.indexOf(attrs[key + lastChar]) !== 0
          ) {
            shouldAdd = false;
            break;
          }
      ...
      HTMLElement.prototype.querySelectorAll =
        function querySelectorAll(selector) {
          if (typeof selector !== "string") {
            throw new TypeError(
              "document.querySelectorAll: Invalid selector type. " +
                "Expect: string. Found: " +
                typeof selector +
                "."
            );
    ...
    document.querySelector =
      ...
      HTMLElement.prototype.querySelector =
        function querySelector(selector) {
          if (typeof selector !== "string") {
            throw new TypeError(
              "document.querySelector: Invalid selector type. " +
                "Expect: string. Found: " +
                typeof selector +
                "."
            );
...
// var polyfillUrl = 'https://polyfill.io/v3/polyfill.min.js?features=Array.prototype.forEach%2CArray.prototype.includes%2CObject.keys%2CString.prototype.includes%2CString.prototype.startsWith%2Cdocument.querySelector';
